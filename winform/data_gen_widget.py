...
from PyQt5.QtWidgets import (
    QWidget, QVBoxLayout, QLabel, QPushButton, QLineEdit, QListWidget, QMessageBox, QSplitter, QTableWidget, QTableWidgetItem, QHBoxLayout, QComboBox, QHeaderView, QProgressBar, QScrollArea, QTabWidget, QFormLayout, QTextEdit
)
...
from worker.data_gen_worker import DataGenInsertWorker
