...
def generate_default_params():
    ...
    return {
        ...
        "signingImage": "http://788360p9o5.yicp.fun/rtx-web/static/img/logo.4eeb8a8e.png",
        "protocolType": 0,
        "idCardUrl": "	http://788360p9o5.yicp.fun/rtx-web/static/img/logo.4eeb8a8e.png",
        "backIdCardUrl": "	http://788360p9o5.yicp.fun/rtx-web/static/img/logo.4eeb8a8e.png",
        "cardHolder": df.random_name(),
        "idCode": df.random_id_number(),
        "idcardValidity": "2016.10.25-2026.10.25",
        "idAddress": "广东省深圳市龙岗区双子塔F座705",
